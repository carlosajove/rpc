...
from simulator.pybullet.rl.rl_mpc_freq.envs.freq_env_tilted_ground_Ly_25 import DracoEnvMpcFreq_tilted_ground_Ly_25
from config.draco.pybullet_simulation import Config

model_dir = cwd + "/rl_model/freq_env/tilted_ground_Ly_25/PPO"
env_dir = cwd + "/rl_env/freq_env/tilted_ground_Ly_25/PPO"
#import tracemalloc
import argparse
import torch
...
if __name__ == "__main__":
    ...
    render = False
    env = DracoEnvMpcFreq_tilted_ground_Ly_25(
    ...
    save_dir = str1 + f"Ly_30_tilted_5_downhill"
    load_dir = str1 + f"Ly_30_tilted_5_downhill"
    load_path = os.path.join(model_dir, load_dir)
    save_path = os.path.join(model_dir, save_dir)
    ## train model
    #policy_kwargs = { 'full_std': False}
    if new_model:
        tensorboard_dir = cwd + "/rl_log/freq_env/Ly_25_tilted_ground/"
