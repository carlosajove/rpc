...
from simulator.pybullet.rl.rl_mpc_freq.envs.only_rl_low_freq import DracoEnvMpcFreq_ONLY_RL_low_freq
...
if __name__ == "__main__":
    ...
    n_steps_ = 8162 #32768 #16384 #256 #8192
    ...
    render = False
    env = DracoEnvMpcFreq_ONLY_RL_low_freq(mpc_freq, sim_dt, reduced_obs_size=reduced_obs_size, render=render)
    ...
    if new_model:
        tensorboard_dir = cwd + "/rl_log/freq_env/ONLY_RL_low_freq/"
