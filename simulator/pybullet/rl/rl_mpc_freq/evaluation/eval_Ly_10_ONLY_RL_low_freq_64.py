...
if __name__ == "__main__":
    ...
    load_path = os.path.join(cwd, 'rl_model/freq_env/Ly_10_higher_lr_Ly_10_only/PPO/redObsONLY_RL_batch_256_nsteps4096_low_freq')
    CURR_TIMESTEP = 7200000
    ...
    env = DracoEnvMpcFreq_ONLY_RL_low_freq_Ly_10(mpc_freq, sim_dt, eval = [0,0,0],reduced_obs_size=reduced_obs_size, render = True)
