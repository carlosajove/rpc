...
if __name__ == "__main__":
    ...
    render = False
    env = DracoEnvOneStepMpcRange(Lx, Ly, yaw_max, mpc_freq, sim_dt, randomized_command=randomized_command, reduced_obs_size=reduced_obs_size, render = render)
