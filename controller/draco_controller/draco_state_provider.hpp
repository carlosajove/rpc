...
public:
  ...
  Eigen::Vector3d
      com_pos_stance_frame_; // rotatin frame is at the end of the swing
  ...
  Eigen::VectorXd get_wbc_obs() {
    ...
    obs << stance_leg_,
        ...
        com_pos_stance_frame_(1), com_pos_stance_frame_(2),
        L_stance_frame_(0), // 8
        L_stance_frame_(1), L_stance_frame_(2),
        stfoot_pos_(0), // 11
        stfoot_pos_(1), stfoot_pos_(2),
        ...
        full_policy_(2), // 23
        state_,          // 24
        torso_com_ang_vel_(0), torso_com_ang_vel_(1),
        torso_com_ang_vel_(2), // 27
        torso_rpy_des_frame(0), torso_rpy_des_frame(1),
        torso_rpy_des_frame(2), // 30
        swfoot_rpy_des_frame(0), swfoot_rpy_des_frame(1),
